...
var _user$project$Mtg$main = {
	main: _elm_lang$html$Html$text('Hello')
};

var Elm = {};
Elm['Mtg'] = Elm['Mtg'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Mtg'], 'Mtg', typeof _user$project$Mtg$main === 'undefined' ? null : _user$project$Mtg$main);
